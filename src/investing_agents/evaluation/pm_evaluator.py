...
You are reviewing an investment report generated by a junior analyst.
...
**Executive Summary:**
- Thesis: {exec_summary.get('thesis', 'MISSING')[:500]}...
- Catalysts: {len(exec_summary.get('catalysts', []))} listed
- Risks: {len(exec_summary.get('risks', []))} listed

**Investment Thesis:**
- Core hypothesis: {thesis.get('core_hypothesis', 'MISSING')[:300]}...
- Length: {len(str(thesis))} characters
    ...
    def _parse_evaluation_response(self, response: str) -> Dict[str, Any]:
        ...
        if json_match:
            try:
                ...
                self.log.error("pm_evaluation.json_parse_failed", error=str(e))
